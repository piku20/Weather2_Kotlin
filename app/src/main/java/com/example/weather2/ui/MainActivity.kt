...
import com.example.weather2.utils.TOKEN
        ...
        binding.apply{
            btnSearch.setOnClickListener{
                ...
                if(location.isNotEmpty()){
                    ...
                    showError(true,"Enter a location")
                }
            }
        }
    }
    ...
    private fun requestToServer(location: String){
        ...
        val stringRequest = StringRequest(Request.Method.GET, url, { response ->
            ...
            try{
                ...
                val humidity = mainObject.getDouble("humidity")
                ...
                binding.layoutWeather.apply{
                    ...
                    val roundValue = ceil(temperature).toInt().toString()
                    tvTemperature.text = roundValue
